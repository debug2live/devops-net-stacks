---
title: "DevOps Networking Roadmap"
date: 2024-04-18
---
...
- [`01_Core_Foundations/`](./01_Core_Foundations): Tài liệu và Labs cho Level 1.
- [`02_Linux_Networking/`](./02_Linux_Networking): Tài liệu và Labs cho Level 2.
- [`03_Container_Orchestration/`](./03_Container_Orchestration): Tài liệu và Labs cho Level 3.
- [`04_Cloud_Advanced/`](./04_Cloud_Advanced): Tài liệu và Labs cho Level 4.

## 🗺️ DevOps Workflow

```mermaid
graph TD
    A[Core Foundations] --> B[Linux Networking]
